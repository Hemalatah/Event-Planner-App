        ...
        setupFormValidation: function()
        {
            ...
            $('#form-create').validate({
                ...
                messages: {
                    ...
                    phone: {
                      required: 'Please enter the phone number in the standard format',
                      phoneUS: 'Please enter the valid phone number in the standard format'
                    },
                    email: {
                    ...
                    zip: {
                      ...
                      validzip: 'Please enter the digits in the format of either "xxxxx-xxxx" or "xxxxx'
                    },
                    country: {
